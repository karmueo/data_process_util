...
IMG_PATH = 'classify/test/kite/a4a69806749c44628b8df595e7797e53.jpg'
...
ort_outputs = ort_session.run(None, ort_inputs)[0]  # [batch, num_classes]
probabilities = torch.tensor(ort_outputs)
